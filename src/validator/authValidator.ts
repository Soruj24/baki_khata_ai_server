...
export const validationRules = {
  ...
  registration: [
    ...
    body("firstName")
      ...
      .withMessage("validation.first_name_max"),
    body("lastName")
      .optional()
      .isLength({ min: 1, max: 50 })
      .withMessage("validation.last_name_max"),
    body("userLanguage")
      .optional()
      .isString()
      .isLength({ min: 2, max: 10 })
      .withMessage("validation.language_invalid"),
  ],
  ...
  userList: [
    ...
    query("search")
      ...
      .trim()
      .isLength({ max: 50 })
      .withMessage("Search cannot exceed 50 characters"),
  ],
  ...
  preferencesUpdate: [
    ...
    body("preferences.timezone")
      .optional()
      .isString()
      .withMessage("Timezone must be a valid timezone"),
    ...
    body("preferences.notifications.twoFactor")
      .optional()
      .isBoolean()
      .withMessage("Two-factor notifications must be boolean"),
  ],
  ...
  adminUpdateUser: [
    ...
    body("status")
      ...
      .withMessage(
        "Status must be one of: active, inactive, suspended, banned, deleted",
      ),
    body("permissions")
      .optional()
      .isArray()
