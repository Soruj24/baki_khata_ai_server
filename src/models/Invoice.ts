...
import type { IInvoice } from '../types/billing.types.ts';
  ...
  },
  {
    ...
    toJSON: {
      ...
      transform: function(doc, ret) {
        ...
        delete json.stripeInvoiceId;
        delete json.isFinalized;
        delete json.finalizedAt;
        delete json.emailSent;
        delete json.emailSentAt;
        return json;
      },
    },
    toObject: {
